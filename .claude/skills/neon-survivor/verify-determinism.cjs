...
const scriptB = ['js/i18n.js', 'js/config-sim.js', 'js/core.js', 'js/audio-orchestrator.js', 'js/upgrade-logic.js', 'js/world.js', 'js/sim.js', 'js/render.js', 'js/ui-engine.js', 'js/main.js']
