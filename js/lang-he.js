...
'CREATE ACCOUNT':'יצירת חשבון','CONFIRM EMAIL':'אימות אימייל','PICK A CALLSIGN':'בחרו כינוי','CHOOSE CALLSIGN':'בחרו כינוי',
'Set a password, then confirm with the 6-digit code we email you.':'הגדירו סיסמה ואשרו עם קוד בן 6 ספרות שנשלח אליכם באימייל.',
'Enter the 6-digit code sent to':'הזינו את הקוד בן 6 הספרות שנשלח אל',
'to finish creating your account.':'כדי לסיים את יצירת החשבון.',
'Enter the 6-digit access code sent via secure uplink to':'הזינו את קוד הגישה בן 6 הספרות שנשלח בערוץ מאובטח אל',
'✔ CREATE ACCOUNT':'✔ צרו חשבון','✔ CONFIRM & ENTER':'✔ אשרו והיכנסו','✔ VERIFY CODE':'✔ אימות קוד',
'✔ CONFIRM':'✔ אישור','✔ ENTER THE GRID':'✔ כניסה לרשת','✔ OK':'✔ אישור',
'↻ Resend code':'↻ שליחת קוד מחדש','← Back':'← חזרה','← Use password':'← כניסה עם סיסמה',
'Have an account? Sign in':'יש לכם חשבון? התחברו',
'How you show up on the global leaderboard. 3–16 characters.':'כך תופיעו בלוח התוצאות העולמי. 3–16 תווים.',
'Pick a callsign for the leaderboard. 3–16 characters.':'בחרו כינוי ללוח התוצאות. 3–16 תווים.',
...
'Network error.':'שגיאת רשת.','Enter the 6-digit code.':'הזינו את הקוד בן 6 הספרות.','Verifying…':'מאמת…',
...
'Sending code…':'שולח קוד…','Resending…':'שולח שוב…','Something went wrong.':'משהו השתבש.',
};
I18N.apply();
