...
const AUDIO_MANIFEST = {
  ...
  genres: {
    ...
    classical: { unlock: 'ascetic', label: 'Classical', ico: '🎹', wardenTitle: 'GRAND RECITAL',
      ...
      // style:'classical' → Alberti broken-chord arpeggio + sustained pad, NO drum kit (agitato 16ths + timpani under boss)
      bed:     { bpm: 76,  prog: [[57,60,64],[55,59,62],[53,57,60],[50,53,57]], bass: [33,31,29,26], drive: false, ostinato: false, style: 'classical' },   // serene nocturne triads
      menubed: { bpm: 66,  prog: [[57,60,64],[52,55,59],[53,57,60],[55,59,62]], bass: [33,28,29,31], drive: false, ostinato: false, style: 'classical' },   // hushed lobby nocturne
      bossbed: { bpm: 138, prog: [[52,55,59],[50,54,57],[51,54,58],[48,52,55]], bass: [28,26,27,24], drive: true,  ostinato: true,  style: 'classical' } }, // storm-movement minor drive
    pop: { unlock: 'veteran', label: 'Pop', ico: '🎤', wardenTitle: 'HEADLINER',
      ...
      // style:'pop' → four-on-floor-lite kick, backbeat clap, bright bell/synth stabs, bouncy octave bass + shimmer pad
      bed:     { bpm: 118, prog: [[60,64,67],[55,59,62],[57,60,64],[53,57,60]], bass: [36,31,33,29], drive: true,  ostinato: false, style: 'pop' },   // bright I–V–vi–IV
      menubed: { bpm: 100, prog: [[60,64,67],[57,60,64],[53,57,60],[55,59,62]], bass: [36,33,29,31], drive: false, ostinato: false, style: 'pop' },   // mellow lounge-pop shimmer
      bossbed: { bpm: 150, prog: [[57,60,64],[53,57,60],[55,59,62],[52,55,59]], bass: [33,29,31,28], drive: true,  ostinato: true,  style: 'pop' } }, // minor-key anthem drop, full-tilt
    metal: { unlock: 'ascendant_rush', label: 'Metal', ico: '🎸', wardenTitle: 'MAIN STAGE',
      ...
      // style:'metal' → galloping kick chug, driving backbeat, detuned-saw power chords (root+5th) + tremolo lead; boss = double-kick blast
      bed:     { bpm: 140, prog: [[57,64,69],[53,60,65],[55,62,67],[52,59,64]], bass: [33,29,31,28], drive: true,  ostinato: true,  style: 'metal' },   // driving power chords
      menubed: { bpm: 92,  prog: [[57,64,69],[52,59,64],[55,62,67],[53,60,65]], bass: [33,28,31,29], drive: false, ostinato: true,  style: 'metal' },   // brooding clean-tone hold
      bossbed: { bpm: 184, prog: [[52,59,64],[50,57,62],[51,58,63],[48,55,60]], bass: [28,26,27,24], drive: true,  ostinato: true,  style: 'metal' } }, // thrash power-chord descent, blast tempo
    acoustic: { unlock: 'bare_bones', label: 'Acoustic', ico: '🪕', wardenTitle: 'MIDNIGHT SET',
      ...
      // style:'acoustic' → soft upright kick + brushed 8th hats, walking upright bass, travis-picked arpeggio + warm body pad
      bed:     { bpm: 96,  prog: [[60,64,67,71],[57,61,64,67],[62,65,69,72],[55,59,62,65]], bass: [36,33,38,31], drive: false, ostinato: false, style: 'acoustic' },  // mellow 7th-chord swing
      menubed: { bpm: 80,  prog: [[60,64,67,71],[55,59,62,65],[57,61,64,67],[53,57,60,64]], bass: [36,31,33,29], drive: false, ostinato: false, style: 'acoustic' },  // soft fingerpicked 7ths at rest
      bossbed: { bpm: 160, prog: [[55,58,62,65],[53,56,60,63],[51,55,58,62],[50,53,57,60]], bass: [31,29,27,26], drive: true,  ostinato: true,  style: 'acoustic' } },// frantic minor-7th chase, walking-bass sprint
